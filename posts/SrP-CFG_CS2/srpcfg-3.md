...
- [SrP-CFG-Installer_CFG一键安装器](https://blog.srprolin.top/posts/2026-01-12-cfg_installer_v2/)
...
- 在 `autoexec.cfg` 中按`[`键启用，存有基础的视角准星配置
- 功能：主武器使用一个自定义视角，切换至其他装备时均为M7视角
- Tips: 无法实现q键切换装备时的视角更换
